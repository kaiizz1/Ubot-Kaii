...
DEVS = list(map(int, os.getenv("DEVS", "7753788387").split()))

API_ID = int(os.getenv("API_ID", "27610531"))

API_HASH = os.getenv("API_HASH", "bbdf751d18ccb311d72bd5b87be0ac38")

BOT_TOKEN = os.getenv("BOT_TOKEN", "8363798119:AAFHj-56J4bxFeAGY9j-iKCVCuup4t9Lj0o")

OWNER_ID = int(os.getenv("OWNER_ID", "7753788387"))
...
LOGS_MAKER_UBOT = int(os.getenv("LOGS_MAKER_UBOT", "-1002830776134"))
